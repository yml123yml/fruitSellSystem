...
var sqlMap = {
  ...
  category: {
    ...
    dongzao: 'select * from allFruit where tip like "%枣%" ',
    huolongguo: 'select * from allFruit tip like "%火龙果%" ',
    jinju: 'select * from allFruit where tip like "%金桔%" ',
    ...
    pipa: 'select * from allFruit where tip like "%枇杷%" ',
    qiyiguo: 'select * from allFruit where tip like "%奇异%" ',
    shiliu: 'select * from allFruit where tip like "%石榴%" ',
