<template>
  <div class="goodDetail">
    <header-detail title="进口水果"></header-detail>
...
export default {
  ...
  mounted () {
    axios.post('/api/category/importFruit').then(res => {
      this.list1 = res.data
    })
  },
  components: {
